                            ...
                            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                <ul class="navbar-nav mr-auto">
                                    ...
                                    <li class="nav-item">
                                        ...
                                        <a class="nav-link position-relative" href="/my-cart">
                                            <span><i class="fa fa-shopping-cart" aria-hidden="true"></i><span id="items-count" class="fc-count"></span></span>
                                        </a>
                                    </li>
                                </ul>
                        ...
                        <div class="col-lg-12 col-sm-12">
                            <div class="searchbar">
                                <div class="input-group">
                                    <input type="text" name="search_item" class="form-control searchbar-input" placeholder="Search for dishes or cuisines" required="">
