                        ...
                        <tr>
                            ...
                            <td class="product-content">
                                <div class="product-top">
                                    ...
                                    <div class="product-price"><span class="amount"><bdi><span class="woocommerce-Price-currencySymbol">$</span>{{$c->itemDetail->price * $c->qty}}</bdi></span></div>
                                </div>
                                <div class="product-bottom">
                                    <div class="product-qty">
                                        <div class="cart-item-qty" data-nonce="dcefd462dc">
                                            <div class="quantity">
                                                <span class="qty-button decrease" onclick="decrease('{{$c->itemDetail->id}}')">
                                                ...
                                                <input type="number" id="qty_"class="input-text qty text"  value="{{ $c->qty }}" title="Qty" size="4" min="0" max="" step="1" placeholder="" inputmode="numeric" autocomplete="off">
                                    ...
                                    <div class="product-remove">
                                        <a onclick="removeitem('{{$c->itemDetail->id}}')" class="remove"><span class="svg-icon "><svg aria-hidden="true" role="img" focusable="false" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg></span><span class="name">Remove</span></a>
                                    </div>
                                </div>
                            </td>
                        </tr>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                    <div class="d-flex timming-row">
                        ...
                        <div><span>OPENING TIME</span><div><b>11:00 - 23:59</b></div></div>
                    </div>
                    <div class="d-flex timming-row">
                        <div><i class="fa-solid fa-phone"></i></div>
                        <div><span>CALL US</span><div><b>123456789</b></div></div>
                    </div>
                    <div class="d-flex timming-row">
                        <div><i class="fa-brands fa-android"></i></div>
                        <div><span>FOR ANDROID</span><div><b>Visit Playstore Store</b></div></div>
                    </div>
                    <div class="d-flex timming-row">
                        <div><i class="fa-brands fa-apple"></i></div>
                        <div><span>FOR IOS</span><div><b>Visit Apple Store</b></div></div>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12"><div class="copyright text-center">&#169; 2023. All Rights Reserved.</div></div>
            </div>
        </div>
    </div>
    <!-- footer -->
