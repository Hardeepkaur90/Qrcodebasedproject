...
<nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none" id="navbarBlur"
    ...
    <div class="container-fluid py-1 px-4">
        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
            ...
            <ul class="navbar-nav  justify-content-end user-nav-link">
                ...
                <li class="nav-item dropdown pe-2 d-flex align-items-center notification">
                                ...
                                <div class="d-flex py-1">
                                    ...
                                    <div class="d-flex flex-column justify-content-center">
                                        <h6 class="text-sm font-weight-normal mb-1">
                                            <span class="font-weight-bold">New Requests</span>  {{ \App\Models\User::where('status', NULL)->count() }}
                                        </h6>
